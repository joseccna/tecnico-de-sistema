...
--
-- Table structure for table `usotransporte`
--

DROP TABLE IF EXISTS `usotransporte`;
...
CREATE TABLE `usotransporte` (
  ...
  `linha_onibus` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_uso`),
  KEY `id_bilhete` (`id_bilhete`),
  CONSTRAINT `usotransporte_ibfk_1` FOREIGN KEY (`id_bilhete`) REFERENCES `bilhetevirtual` (`id_bilhete`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `usotransporte`
--

LOCK TABLES `usotransporte` WRITE;
/*!40000 ALTER TABLE `usotransporte` DISABLE KEYS */;
/*!40000 ALTER TABLE `usotransporte` ENABLE KEYS */;
UNLOCK TABLES;
